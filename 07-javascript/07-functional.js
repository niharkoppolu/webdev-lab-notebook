...
const mapNameFamily = (characters) => {
  ...
  return characters.map((person) => person.name + ", of House " + person.house);
};

const filterFamily = (characters, house) => {
  // Return an array with only the characters from a given house

  return characters.filter((person) => person.house === house);
};
...
const reduceHouses = (characters) => {
  ...
  obj.Stark = characters.reduce((accumulator, person) => {
    if (person.house == "Stark") return accumulator + 1;
    else return accumulator;
  }, 0);
  obj.Lannister = characters.reduce((accumulator, person) => {
    if (person.house == "Lannister") return ++accumulator;
    else return accumulator;
  }, 0);
  obj.Targaryen = characters.reduce((accumulator, person) => {
    if (person.house == "Targaryen") return ++accumulator;
    else return accumulator;
  }, 0);
  obj.Greyjoy = characters.reduce((accumulator, person) => {
    if (person.house == "Greyjoy") return ++accumulator;
    else return accumulator;
  }, 0);
  obj.Seaworth = characters.reduce((accumulator, person) => {
    if (person.house == "Seaworth") return ++accumulator;
    else return accumulator;
  }, 0);
  obj.Tarth = characters.reduce((accumulator, person) => {
    if (person.house == "Tarth") return ++accumulator;
    else return accumulator;
  }, 0);
